...
const cards = GAMES_JSON.reduce((acc, game) => {
    return acc + game.pledged;
}, 0);
// set inner HTML using template literal
raisedCard.innerHTML = `$${cards.toLocaleString()}`;
...
const displayStr = `A total of $${cards.toLocaleString()} has been raised for ${GAMES_JSON.length} games.
Currently, ${numUnfunded} ${numUnfunded === 1 ? "game" : "games"} remains unfunded.
